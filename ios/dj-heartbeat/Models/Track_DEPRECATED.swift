...
struct Track_DEPRECATED: Codable, Identifiable, TrackInfo, Equatable, Hashable {
    let id: String
...
let mockTrack2 = Track_DEPRECATED(
...
let mockTrack3 = Track_DEPRECATED(
...
let mockTrack4 = Track_DEPRECATED(
...
let mockTrack5 = Track_DEPRECATED(
...
let mockTrack6 = Track_DEPRECATED(
...
let mockTrack7 = Track_DEPRECATED(
...
let mockTrack8 = Track_DEPRECATED(
...
let mockTrack9 = Track_DEPRECATED(
...
let mockTrack10 = Track_DEPRECATED(
...
let mockTrack11 = Track_DEPRECATED(
...
let mockTrackNotOnDefaultPlaylist = Track_DEPRECATED(id: "65d51bfd97adba6037fd2964", trackDurationMS: 148485, name: "I Ain't Worried", artist: "OneRepublic", albumArtURLString: "https://i.scdn.co/image/ab67616d0000b273ec96e006b8bdfc582610ec13")
